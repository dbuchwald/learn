...
(
    ...
    CONSTRAINT PK_customer_identifier PRIMARY KEY CLUSTERED(customer_id, identifier_id),
    CONSTRAINT FK_customer_id FOREIGN KEY (customer_id) REFERENCES dbo.customers (id),
    CONSTRAINT FK_identifier_id FOREIGN KEY (identifier_id) REFERENCES dbo.identifier_types (id)
)